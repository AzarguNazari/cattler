...
* The original package name 'com.example.docker-client' is invalid and this project uses 'com.example.dockerclient' instead.
...
```
$ docker run --rm -p 8080:8080 docker-client:0.0.1-SNAPSHOT
```
